...
setup(
    name={{cookiecutter.project_name}}.__name__,
    version={{cookiecutter.project_name}}.__version__,
    description='{{cookiecutter.project_name}} is a function composition and data pipelining library',
    long_description=__doc__,
    url='https://github.com/ForeverWintr/metafunctions',
    author={{cookiecutter.project_name}}.__author__,
    author_email={{cookiecutter.project_name}}.__email__,
    license='MIT',
